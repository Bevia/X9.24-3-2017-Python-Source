...
def Generate_Working_Keys( d, workingKeyUsage, workingKeyType ):
    ...
    D(d, "Generate_Working_Keys(workingKeyUsage =", workingKeyUsage, "workingKeyType =", workingKeyType, ")")
...
def Update_Derivation_Keys( d, start, deriveKeyType ):
    ...
    while j != 0:
        ...
        D(d+1, "gIntermediateDerivationKeyRegister[", i, "] <- ", gIntermediateDerivationKeyRegister[i])
